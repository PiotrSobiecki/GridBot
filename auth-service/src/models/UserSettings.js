...
const priceThresholdSchema = new mongoose.Schema({
  condition: { type: String, enum: ['less', 'lessEqual', 'greater', 'greaterEqual'], required: true },
...
const orderSchema = new mongoose.Schema({
  ...
  buy: {
    ...
    mode: { type: String, enum: ['onlySold', 'maxDefined', 'walletLimit'], default: 'walletLimit' },
  ...
  sell: {
    ...
    walletProtection: { type: Number, default: 0 },
    mode: { type: String, enum: ['onlyBought', 'maxDefined', 'walletLimit'], default: 'walletLimit' },
    maxValue: { type: Number, default: 0 },
    addProfit: { type: Boolean, default: false }
  },
